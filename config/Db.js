...
//Função assíncrona, porque vai aguardar ele tentar conectar através da URi
const InicializaMongoServer = async() => {
    try {
        await mongoose.connect(MONGOURI, {
            useNewUrlParser: true, //Forçamos a utilizar o ultimo parse de URL. Digo que é uma URL válida
            useCreateIndex: true, //Qdo necessário, utilizará a criação de índices, caso eu tenha pedido
